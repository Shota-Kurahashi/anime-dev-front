...
export const Footer = () => (
  <footer className="fixed bottom-0 z-10 flex h-20 w-full flex-row items-center  border-t bg-white md:z-10 md:flex md:h-full md:w-20  md:flex-col md:justify-center md:space-y-10 md:border-t-0 md:border-r md:pt-16">
    ...
    <div className="group relative basis-1/5 cursor-pointer md:basis-0">
      ...
      <div className=" pointer-events-none absolute left-[150%] top-1/2 hidden -translate-y-1/2 whitespace-nowrap rounded bg-black p-2 text-sm text-white opacity-0 transition-all duration-500  before:absolute before:top-1/2 before:right-full before:-translate-y-1/2 before:border-[6px] before:border-transparent before:border-r-black before:content-[''] group-hover:-translate-x-[5%] group-hover:opacity-100 md:block">
        ホーム
      </div>
    </div>
